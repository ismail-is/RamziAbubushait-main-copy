...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={2} footerStyle={1} breadcrumbTitle="Apex Remodeling">
                    ...
                    <div className="col-xl-8">
                        <div className="services-details__content">
                            <div className="services-details__content-img1">
                                <img src="assets/images/services/services-details-img8.jpg" alt=""/>
                            </div>

                            <div className="services-details__content-text1">
                                <h2>Apex Remodeling</h2>
                        ...
                        <div className="sidebar">
                            ...
                            <div className="sidebar__single sidebar__services wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <ul className="sidebar__services-list">
                                    ...
                                    <li className="active"><Link href="#">Apex Remodeling <span
                                                className="icon-right-arrow"></span></Link>
                                    </li>
                                </ul>
                            </div>
