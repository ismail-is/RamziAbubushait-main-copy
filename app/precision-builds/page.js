...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={2} footerStyle={1} breadcrumbTitle="Precision Builds">
                    ...
                    <div className="col-xl-8">
                        <div className="services-details__content">
                            <div className="services-details__content-img1">
                                <img src="assets/images/services/services-details-img7.jpg" alt=""/>
                            </div>

                            <div className="services-details__content-text1">
                                <h2>Precision Builds</h2>
                        ...
                        <div className="sidebar">
                            ...
                            <div className="sidebar__single sidebar__services wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <ul className="sidebar__services-list">
                                    <li><Link href="structural-mastery">Structural Mastery <span
                                    ...
                                    <li className="active"><Link href="#">Precision Builds <span
                                                className="icon-right-arrow"></span></Link>
                                    </li>
